export default function Home() {
  return (
    <main>
      {/* Hero Section */}
      <section className="bg-white py-10 md:py-20 px-[30px] md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-[36px] md:text-5xl lg:text-6xl font-bold text-forestGreen mb-6 leading-[1.2] tracking-tight">
            We bring life and beauty to your outdoors
          </h1>
          <p className="text-base md:text-lg text-gray-600 mb-10 max-w-2xl mx-auto leading-[1.7] px-2">
          ...
          {/* Hero Image */}
          <div className="rounded-xl overflow-hidden bg-gradient-to-br from-green-200 to-green-300 aspect-video flex items-center justify-center">
      ...
      <section className="bg-white py-10 md:py-16 px-[30px] md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-xl overflow-hidden bg-gradient-to-br from-green-200 to-green-300 aspect-video flex items-center justify-center mb-8">
            <p className="text-forestGreen text-lg font-medium">
          ...
          <p className="text-gray-600 leading-[1.7] max-w-2xl mx-auto">
      ...
      <section className="bg-white py-10 md:py-16 px-[30px] md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-xl overflow-hidden bg-gradient-to-br from-orange-200 to-yellow-200 aspect-video flex items-center justify-center mb-8">
            <p className="text-forestGreen text-lg font-medium">
      ...
      <section className="bg-white py-10 md:py-16 px-[30px] md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-xl overflow-hidden bg-gradient-to-br from-gray-200 to-blue-100 aspect-video flex items-center justify-center mb-8">
            <p className="text-forestGreen text-lg font-medium">
